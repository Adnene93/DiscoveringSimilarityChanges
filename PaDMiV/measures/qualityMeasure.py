...
def quality_disagreement_sumdifferences_withbound(original_model,pattern_model,threshold_pair_comparaison,coeff=lambda x : 1):
    qps=[]
    qps_max=[]
    qps_append=qps.append
    qps_max_append=qps_max.append
    ...
    for i in range(len(original_model)):
        ...
        for j in range(len(row_original)):
            agg_o,all_o=row_original[j]
            agg_p,all_p,min_sim_expected=row_pattern[j]
...
def quality_agreement_sumdifferences_withbound(original_model,pattern_model,threshold_pair_comparaison,coeff=lambda x : 1):
    qps=[]
    qps_max=[]
    qps_append=qps.append
    qps_max_append=qps_max.append
    ...
    for i in range(len(original_model)):
        ...
        for j in range(len(row_original)):
            agg_o,all_o=row_original[j]
            agg_p,all_p,max_sim_expected=row_pattern[j]
